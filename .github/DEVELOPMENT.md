...
```shell
git clone https://github.com/(your-name-here)/github-sponsors-to-markdown
cd github-sponsors-to-markdown
pnpm install
```
...
VS Code will automatically run the `build` task in the background before running `./bin/github-sponsors-to-markdown.js`.
